      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto bg-slate-50 p-6 custom-scrollbar sm:p-8">
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
                <button
                  ...
                  className={`group relative flex min-h-[148px] w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-2xl border-2 p-4 text-center transition-all ${
                    isAllSelected
                      ? 'border-indigo-600 bg-indigo-50 text-indigo-900 shadow-[2px_2px_0px_0px_rgba(79,70,229,1)]'
                      : 'border-slate-900 bg-white text-slate-900 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-1 hover:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)]'
                  }`}
                >
                  {isAllSelected && (
                ...
                {vocationalGroupsList.map(group => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex min-h-[148px] w-full flex-col items-center gap-2 overflow-hidden rounded-2xl border-2 p-4 text-center transition-all ${
                        isSelected && !isAllSelected
                          ? 'border-indigo-600 bg-indigo-50 text-indigo-900 shadow-[2px_2px_0px_0px_rgba(79,70,229,1)]'
                          : 'border-slate-900 bg-white shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-1 hover:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)]'
            ...
            <div className="flex shrink-0 flex-col items-center justify-end gap-3 border-t-4 border-slate-900 bg-white p-4 sm:flex-row">
