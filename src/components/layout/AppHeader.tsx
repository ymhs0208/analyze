...
export default function AppHeader({ isScrolled, onShareClick, onMenuClick, isMenuOpen = false }: AppHeaderProps) {
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 pointer-events-none transition-all duration-300 ${isScrolled ? 'p-2 sm:p-2' : 'p-2 sm:p-4'}`}>
      <div className="max-w-6xl mx-auto pointer-events-auto">
        <header className={`bg-white/90 backdrop-blur-md rounded-3xl flex items-center justify-between transition-all duration-300 will-change-transform ${isScrolled ? 'border-2 border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] p-2 sm:p-3' : 'border-4 border-slate-900 shadow-[5px_5px_0px_0px_rgba(15,23,42,1)] p-2 sm:p-4 hover:-translate-y-0.5 hover:shadow-[8px_8px_0px_0px_rgba(15,23,42,1)]'}`}>
          <div className="flex items-center gap-3 sm:gap-4">
            <div className={`bg-indigo-600 border-slate-900 flex items-center justify-center text-white font-black text-2xl shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] transition-all ${isScrolled ? 'w-10 h-10 sm:w-10 sm:h-10 rounded-xl border-2 sm:text-xl' : 'w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl border-2 sm:border-4 sm:text-3xl'}`}>
              會
            </div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className={`flex items-center justify-center gap-2 bg-amber-400 text-slate-900 border-slate-900 font-black transition hover:bg-amber-300 active:translate-y-1 active:shadow-none ${isScrolled ? 'px-3 h-10 sm:h-10 rounded-xl border-2 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]' : 'w-10 h-10 px-0 rounded-xl border-2 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] sm:w-auto sm:h-14 sm:px-5 sm:rounded-2xl sm:border-4 sm:shadow-[4px_4px_0px_0px_rgba(15,23,42,1)]'}`}
            >
            ...
            <button
              ...
              aria-label="開啟分享選單"
              className={`bg-emerald-200 flex items-center justify-center border-slate-900 transition hover:bg-emerald-300 active:translate-y-1 active:shadow-none ${isScrolled ? 'w-10 h-10 sm:w-10 sm:h-10 rounded-xl border-2 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]' : 'w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl border-2 sm:border-4 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)]'}`}
            >
            ...
            <button
              ...
              className={`bg-sky-200 flex items-center justify-center border-slate-900 transition hover:bg-sky-300 active:translate-y-1 active:shadow-none ${isScrolled ? 'w-10 h-10 sm:w-10 sm:h-10 rounded-xl border-2 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]' : 'w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl border-2 sm:border-4 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)]'}`}
            >
